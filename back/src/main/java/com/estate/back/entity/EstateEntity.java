...
public class EstateEntity {
    ...
    private Double leaseRatio;    // 40m2 이하 매매가 대비 전세가 비율
    ...
    private Double monthRentRatio6085; // 40m2초과 85m2 이하 전세가 대비 월세 보증금 비율
    private Double monthRentRatio85; // 85m2 초과 매매가 대비 전세가 대비 월세 보증금 비율
}
